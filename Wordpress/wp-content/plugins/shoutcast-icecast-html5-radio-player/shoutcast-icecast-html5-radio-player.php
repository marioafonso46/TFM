...
Plugin URI: https://www.svnlabs.com/html5plus/shop/html5-mp3-radio-fm-stream/
...
Author URI: https://www.svnlabs.com/html5plus/shop/html5-mp3-radio-fm-stream/
*/ 
...
// Options/Settings page in WP-Admin
		function config_page() {
			...
			update_option("shoutcast-icecast-html5-player-title", mysql_real_escape_string($titlez));
...
Podcast MP3 (http://www.domain.com/directory/filename.mp3)</em>
  ...
  function generatePlayerCode()
  {
	...
	document.getElementById("iframe").innerHTML = '<iframe src="https://player.radioforge.com/v2/'+radiotype+'.html?radiolink='+radiolink+'&radiotype='+radiotype+'&bcolor='+bcolor+'&image='+image+'&facebook='+facebook+'&twitter='+twitter+'&title='+title+'&artist='+artist+'" frameborder="0" marginheight="0" marginwidth="0" scrolling="no" width="367" height="227"></iframe>';


    document.getElementById("embed").innerHTML = '<textarea cols="60" rows="10" onFocus="this.select();" style="border:1px dotted #343434" ><iframe src="https://player.radioforge.com/v2/'+radiotype+'.html?radiolink='+radiolink+'&radiotype='+radiotype+'&bcolor='+bcolor+'&image='+image+'&facebook='+facebook+'&twitter='+twitter+'&title='+title+'&artist='+artist+'" frameborder="0" marginheight="0" marginwidth="0" scrolling="no" width="367" height="227"></iframe></textarea>';	
...
$iframe = '<iframe src="https://player.radioforge.com/v2/'.$radiotype.'.html?radiolink='.$radiolink.'&radiotype='.$radiotype.'&bcolor='.$bcolor.'&image='.$image.'&facebook='.$facebook.'&twitter='.$twitter.'&title='.$titlez.'&artist='.$artist.'" frameborder="0" marginheight="0" marginwidth="0" scrolling="no" width="367" height="227"></iframe>';
...
<strong><a href="https://www.svnlabs.com/html5plus/shop/html5-mp3-radio-fm-stream/" target="_blank">HTML5 MP3 Radio FM MP3 Stream Player</a></strong>
...
$echo = '<iframe src="https://player.radioforge.com/v2/'.$radiotype.'.html?radiotype='.$radiotype.'&radiolink='.$radiolink.'&rand='.rand().'&bcolor='.$bcolor.'&image='.$image.'&facebook='.$facebook.'&twitter='.$twitter.'&title='.$titlez.'&artist='.$artist.'" frameborder="0" marginheight="0" marginwidth="0" scrolling="no" width="367" height="227"></iframe>';
...
function upgrade_to_pro_html5_radio_player($links) { 
	...
	if (function_exists('is_plugin_active') && !is_plugin_active('shoutcast-icecast-html5-radio-playlist/list.php')) {
		...
		$links[] = '<a href="https://www.svnlabs.com/html5plus/shop/html5-mp3-radio-fm-stream/" target="_blank">' . __("Go Pro", "metaslider") . '</a>'; 
